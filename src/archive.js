...
exports = module.exports = {
  ...
  deletedRepos: function(config, mode) {
  ...
  archive: function(repo, done) {
    ...
    async.series([
        exports.tarball.bind(exports.tarball, paths.snapshot.code, paths.archive.code),
        exports.tarball.bind(exports.tarball, paths.snapshot.wiki, paths.archive.wiki)
      ],
      function(err) {
        if (err) {
   ...
   */
  /* istanbul ignore next */
  repoBatch: function(batch, done) {
    log.debug('Process one batch of', batch.length, 'repos');

    async.each(batch, exports.archive, function(err) {
      if (err) {
  ...
  processDeleted: function(config, mode, done) {
    exports.deletedRepos(config, mode)
      .then(
        function(repos) {
